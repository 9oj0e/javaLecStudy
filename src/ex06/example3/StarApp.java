...
public class StarApp {
    ...
    public static void gameStart(Reaver u1, Reaver u2){
        u1.attack();
        u2.attack();
    }
    ...
    public static void gameStart(Dragoon u1, Reaver u2){
        u1.attack();
        u2.attack();
    }
    ...
    public static void gameStart(Reaver u1, Dragoon u2){
        u1.attack();
        u2.attack();
    }
    public static void gameStart(Reaver u1, Zealot u2){
        u1.attack();
        u2.attack();
    }
    ...
    public static void gameStart(Zealot u1, Reaver u2){
        u1.attack();
        u2.attack();
    }
